...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-dark">Edit Produk</h3>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control-plaintext fw-bold"
                            value="{{ $product->stock }} (Gunakan menu Stok Log untuk update)" readonly>
                    </div>
                    ...
                    <div class="col-12">
                        <label for="image" class="form-label">Gambar Produk (Biarkan kosong jika tidak ubah)</label>
                        @if ($product->image)
                            <div class="mb-2">
